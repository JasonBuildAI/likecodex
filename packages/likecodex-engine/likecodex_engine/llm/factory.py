...
def create_provider(
    ...
    if provider_norm in {"deepseek", "openai", "azure"}:
        # DeepSeek-only: legacy openai/azure names route to DeepSeek API.
    ...
    raise ValueError(f"Unsupported LLM provider: {provider}. Use 'deepseek' or 'mock'.")
