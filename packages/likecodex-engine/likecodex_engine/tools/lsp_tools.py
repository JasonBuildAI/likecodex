...
class LspSemanticTools:
    ...
    def lsp_definition_schema(self) -> dict[str, Any]:
        return {
            "description": "Jump to symbol definition via LSP.",
            "parameters": {
                "type": "object",
                "properties": {
                    "file": {"type": "string"},
    ...
    def lsp_references_schema(self) -> dict[str, Any]:
        return {
            "description": "Find symbol references via LSP (falls back to grep hint).",
            "parameters": {
                "type": "object",
                "properties": {
                    "file": {"type": "string"},
    ...
    def lsp_hover_schema(self) -> dict[str, Any]:
        return {
            "description": "Show hover docs for a symbol.",
            "parameters": {
                "type": "object",
                "properties": {
                    "file": {"type": "string"},
